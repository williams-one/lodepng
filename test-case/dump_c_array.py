#!/usr/bin/env python3
def main():
    # Define an array of hex numbers.
    # These are actually integers written in hex notation.
    hex_array = [
    ...
    # Convert the list of integers into a bytearray.
    data = bytearray(hex_array)

    # Open the file in binary write mode and write the bytearray to the file.
    with open("octocat_32bpp.png", "wb") as binary_file:
